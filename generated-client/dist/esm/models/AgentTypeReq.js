 ...
 */
export function instanceOfAgentTypeReq(value) {
    if (!('name' in value) || value['name'] === undefined)
        return false;
    return true;
}
export function AgentTypeReqFromJSON(json) {
    return AgentTypeReqFromJSONTyped(json, false);
}
export function AgentTypeReqFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AgentTypeReqToJSON(json) {
    return AgentTypeReqToJSONTyped(json, false);
}
export function AgentTypeReqToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {

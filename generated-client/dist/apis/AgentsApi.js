...
class AgentsApi extends runtime.BaseAPI {
    ...
    agentTypesGetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.AgentTypesGet200ResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Retrieves a paginated list of agent types
    ...
    agentTypesIdGetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.AgentTypeResFromJSON)(jsonValue));
        });
    }
    /**
     * Retrieves a specific agent type by ID
    ...
    agentsGetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.AgentsGet200ResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Retrieves a paginated list of agents
    ...
    agentsIdGetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.AgentResFromJSON)(jsonValue));
        });
    }
    /**
     * Retrieves a specific agent by ID
    ...
    agentsIdPatchRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.AgentReqToJSON)(requestParameters['agentReq']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.AgentResFromJSON)(jsonValue));
        });
    }
    ...
    agentsMeStatusPutRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.AgentsMeStatusPutRequestToJSON)(requestParameters['agentsMeStatusPutRequest']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.AgentResFromJSON)(jsonValue));
        });
    }
    ...
    agentsPostRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.AgentCreateResFromJSON)(jsonValue));
        });
    }
    /**
     * Creates a new agent and returns the agent data with an authentication token

...
class TokensApi extends runtime.BaseAPI {
    ...
    tokensGetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.TokensGet200ResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Retrieves a paginated list of tokens
    ...
    tokensIdPatchRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.TokensIdPatchRequestToJSON)(requestParameters['tokensIdPatchRequest']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.TokenResFromJSON)(jsonValue));
        });
    }

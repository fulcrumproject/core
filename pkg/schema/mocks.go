...
// The first argument is typically a *testing.T value.
func NewMockAuthorizer[C any](t interface {
	mock.TestingT
	Cleanup(func())
}) *MockAuthorizer[C] {
	mock := &MockAuthorizer[C]{}
	mock.Mock.Test(t)
...
type MockAuthorizer[C any] struct {
	mock.Mock
}

type MockAuthorizer_Expecter[C any] struct {
	mock *mock.Mock
}

func (_m *MockAuthorizer[C]) EXPECT() *MockAuthorizer_Expecter[C] {
	return &MockAuthorizer_Expecter[C]{mock: &_m.Mock}
}

// Authorize provides a mock function for the type MockAuthorizer
func (_mock *MockAuthorizer[C]) Authorize(ctx context.Context, schemaCtx C, operation Operation, propPath string, hasNewValue bool, config map[string]any) error {
	ret := _mock.Called(ctx, schemaCtx, operation, propPath, hasNewValue, config)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, C, Operation, string, bool, map[string]any) error); ok {
		r0 = returnFunc(ctx, schemaCtx, operation, propPath, hasNewValue, config)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
type MockAuthorizer_Authorize_Call[C any] struct {
	*mock.Call
}
...
func (_e *MockAuthorizer_Expecter[C]) Authorize(ctx interface{}, schemaCtx interface{}, operation interface{}, propPath interface{}, hasNewValue interface{}, config interface{}) *MockAuthorizer_Authorize_Call[C] {
	return &MockAuthorizer_Authorize_Call[C]{Call: _e.mock.On("Authorize", ctx, schemaCtx, operation, propPath, hasNewValue, config)}
}

func (_c *MockAuthorizer_Authorize_Call[C]) Run(run func(ctx context.Context, schemaCtx C, operation Operation, propPath string, hasNewValue bool, config map[string]any)) *MockAuthorizer_Authorize_Call[C] {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockAuthorizer_Authorize_Call[C]) Return(err error) *MockAuthorizer_Authorize_Call[C] {
	_c.Call.Return(err)
	return _c
}

func (_c *MockAuthorizer_Authorize_Call[C]) RunAndReturn(run func(ctx context.Context, schemaCtx C, operation Operation, propPath string, hasNewValue bool, config map[string]any) error) *MockAuthorizer_Authorize_Call[C] {
	_c.Call.Return(run)
	return _c
}

// ValidateConfig provides a mock function for the type MockAuthorizer
func (_mock *MockAuthorizer[C]) ValidateConfig(propPath string, config map[string]any) error {
...
// MockAuthorizer_ValidateConfig_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ValidateConfig'
type MockAuthorizer_ValidateConfig_Call[C any] struct {
	*mock.Call
}
...
//   - propPath string
//   - config map[string]any
func (_e *MockAuthorizer_Expecter[C]) ValidateConfig(propPath interface{}, config interface{}) *MockAuthorizer_ValidateConfig_Call[C] {
	return &MockAuthorizer_ValidateConfig_Call[C]{Call: _e.mock.On("ValidateConfig", propPath, config)}
}

func (_c *MockAuthorizer_ValidateConfig_Call[C]) Run(run func(propPath string, config map[string]any)) *MockAuthorizer_ValidateConfig_Call[C] {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockAuthorizer_ValidateConfig_Call[C]) Return(err error) *MockAuthorizer_ValidateConfig_Call[C] {
	_c.Call.Return(err)
	return _c
}

func (_c *MockAuthorizer_ValidateConfig_Call[C]) RunAndReturn(run func(propPath string, config map[string]any) error) *MockAuthorizer_ValidateConfig_Call[C] {
	_c.Call.Return(run)
	return _c
}

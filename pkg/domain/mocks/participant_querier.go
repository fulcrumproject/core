...
func (_mock *MockParticipantQuerier) Get(ctx context.Context, id properties.UUID) (*domain.Participant, error) {
	ret := _mock.Called(ctx, id)
...
func (_c *MockParticipantQuerier_Get_Call) Return(participant *domain.Participant, err error) *MockParticipantQuerier_Get_Call {
	_c.Call.Return(participant, err)
	return _c
}

func (_c *MockParticipantQuerier_Get_Call) RunAndReturn(run func(ctx context.Context, id properties.UUID) (*domain.Participant, error)) *MockParticipantQuerier_Get_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function for the type MockParticipantQuerier
func (_mock *MockParticipantQuerier) List(ctx context.Context, scope *auth.IdentityScope, req *domain.PageReq) (*domain.PageRes[domain.Participant], error) {
...
func (_c *MockParticipantQuerier_List_Call) Run(run func(ctx context.Context, scope *auth.IdentityScope, req *domain.PageReq)) *MockParticipantQuerier_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockParticipantQuerier_List_Call) Return(pageRes *domain.PageRes[domain.Participant], err error) *MockParticipantQuerier_List_Call {
	_c.Call.Return(pageRes, err)
	return _c
}

func (_c *MockParticipantQuerier_List_Call) RunAndReturn(run func(ctx context.Context, scope *auth.IdentityScope, req *domain.PageReq) (*domain.PageRes[domain.Participant], error)) *MockParticipantQuerier_List_Call {
	_c.Call.Return(run)
	return _c
}

...
func (_mock *MockAgentTypeQuerier) Get(ctx context.Context, id properties.UUID) (*domain.AgentType, error) {
	ret := _mock.Called(ctx, id)
...
func (_c *MockAgentTypeQuerier_Get_Call) Return(agentType *domain.AgentType, err error) *MockAgentTypeQuerier_Get_Call {
	_c.Call.Return(agentType, err)
	return _c
}

func (_c *MockAgentTypeQuerier_Get_Call) RunAndReturn(run func(ctx context.Context, id properties.UUID) (*domain.AgentType, error)) *MockAgentTypeQuerier_Get_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function for the type MockAgentTypeQuerier
func (_mock *MockAgentTypeQuerier) List(ctx context.Context, scope *auth.IdentityScope, req *domain.PageReq) (*domain.PageRes[domain.AgentType], error) {
...
func (_c *MockAgentTypeQuerier_List_Call) Run(run func(ctx context.Context, scope *auth.IdentityScope, req *domain.PageReq)) *MockAgentTypeQuerier_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockAgentTypeQuerier_List_Call) Return(pageRes *domain.PageRes[domain.AgentType], err error) *MockAgentTypeQuerier_List_Call {
	_c.Call.Return(pageRes, err)
	return _c
}

func (_c *MockAgentTypeQuerier_List_Call) RunAndReturn(run func(ctx context.Context, scope *auth.IdentityScope, req *domain.PageReq) (*domain.PageRes[domain.AgentType], error)) *MockAgentTypeQuerier_List_Call {
	_c.Call.Return(run)
	return _c
}

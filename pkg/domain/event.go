...
// WithConfigPool sets the entity ID for the event
func WithConfigPool(t *ConfigPool) EventOption {
	return func(e *Event) error {
		e.EntityID = &t.ID
		return nil
	}
...
func WithConfigPoolValue(t *ConfigPoolValue) EventOption {
	return func(e *Event) error {
		e.EntityID = &t.ID
		return nil
	}
...
// WithServiceOption sets the entity ID for the event
func WithServiceOption(t *ServiceOption) EventOption {
	return func(e *Event) error {
		e.EntityID = &t.ID
		e.ProviderID = &t.ProviderID
		return nil
